...
public class EmployeeAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
			 throws ServletException, IOException
			{
			 ...
			 String output = empObj.updateEmployee(paras.get("hidEmpIDSave").toString(),
			 paras.get("empName").toString(),
			paras.get("empNIC").toString(),
			paras.get("empBdate").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
			...
			{
			 Map paras = getParasMap(request);
			 String output = empObj.deleteUnit(paras.get("empID").toString());
			response.getWriter().write(output);
			}
